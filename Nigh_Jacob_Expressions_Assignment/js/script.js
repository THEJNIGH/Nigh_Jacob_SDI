...
var a = peices[0]; // Declared and defined a and made it equal to the first piece of the array
a *= peices[2]; // Use of second assignment operator and took a and multiplied it to the last part of the array
var total = a /2; // Last part declared and defined total and make it equal to a divided by 2
